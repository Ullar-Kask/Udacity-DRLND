...
LR_ACTOR = 9.99e-4      # learning rate of the actor network
LR_CRITIC = 9.99e-4     # learning rate of the critic network
WEIGHT_DECAY = 0.0      # L2 weight decay

actor_weights_file = 'weights_actor.pt'
critic_weights_file = 'weights_critic.pt'
...
class Agent():
    ...
    def save_weights(self):
        ...
        torch.save(self.critic_local.state_dict(), critic_weights_file)
